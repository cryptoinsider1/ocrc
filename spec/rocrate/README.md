# OCRC Profile for RO-Crate

RO-Crate is a lightweight packaging format for research data. This directory defines the OCRC profile, which adds specific requirements and conventions for using RO-Crate within OCRC.
